...
The module requires L<JSON::XS>, L<Encode>, and L<Exporter::Lite>.

The module can be used with Perl 5.8 or later.  Note that older
versions of Perl (including 5.8) can't handle broken Unicode
characters well such that not all tests pass.  Therefore use of newer
versions of Perl is recommended.
...
Tarballs of old versions of this module is available at:
<http://wakaba.github.com/packages/perl/#JSON-Functions-XS>.  Snapshot
versions are obsolete; use GitHub repository instead.
